...
* **Breaking:** Rename `DockerImageRegistry.KEYCLOAK_DEFAULT_IMAGE` to `DEFAULT_KEYCLOAK_IMAGE`; downstream code referencing the old constant name must be updated
-------
